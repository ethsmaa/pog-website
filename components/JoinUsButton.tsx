...
export default function JoinUsButton({ className }: JoinUsButtonProps) {
  return (
    <a
      ...
      className={twMerge(
        "bg-gradient-to-b from-joinusGradientFrom via-joinusGradientVia to-joinusGradientTo rounded-full p-2 text-black border-black border-2 w-[145px] flex justify-center items-center z-10",
        className
      )}
    >
      Üye Ol
