          ...
          <div className="w-full space-y-3 md:space-y-4 mt-3">
            {events.map((event, index) => (
              <EventBox
                ...
                isHidden={selectedEvent !== null && selectedEvent !== index} // Hide non-selected events
              />
            ))}
          </div>
        </div>
